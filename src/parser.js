...
import { getTaggedTemplateLiteralContent } from './utils/tagged-template-literal'
import {
  fixIndentation,
...
import { isHelper } from './utils/styled'
import { getSourceMap } from './utils/parse'
...
const parser = node => {
  ...
  sourceMap = Object.assign(
    ...
    getSourceMap(
      extractedCSS.join('\n'),
      wrappedContent,
      processedNode.quasi.loc.start.line
    )
  )
